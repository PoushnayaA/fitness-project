...
},{"./extra-options/active-card":1,"./extra-options/scroll":2,"./modules/accordion/init-accordion":5,"./modules/form-validate/form":7,"./modules/sliders/init-slider-jury":13,"./modules/sliders/init-slider-reviews":14,"./modules/tabs/init-tabs":15,"./modules/video/init-video":17,"./utils/ios-vh-fix":19}],4:[function(require,module,exports){
"use strict";
...
var sliderJury = document.querySelector('[data-jury="jury-swiper"]');
var buttonNext = document.querySelector('[data-jury="jury-button-next"]');
var buttonPrev = document.querySelector('[data-jury="jury-button-prev"]');
...
var sliderReviews = document.querySelector('[data-reviews="reviews"]');
